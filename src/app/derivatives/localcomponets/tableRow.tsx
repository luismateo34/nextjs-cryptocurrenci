...
export const RowTable: FC<DerivateCriptointerface> = ({
  ...
  return (
    <div
      key={symbol}
      className={`w-full rounded-md h-[10vh] grid grid-cols-2 gap-2 border-white border-2   ${
        value === symbol ? "bg-white/40" : " bg-sky-500/20"
      }`}
    >
      ...
      <div className="col-start-2 col-end-3 place-self-center">
        <ButtonClient
          ...
          value={symbol}
	  className={"bg-amber-300 text-red-800 border-purple-800 rounded-md p-2 w-full"}
        >
          view date
        </ButtonClient>
      </div>
